...
class FakeSpacyNlp:
    ...
    def __call__(self, text: str) -> FakeDoc:
        sents: list[FakeSent] = []
        pos = 0
        # Split simple: divide en ". " manteniendo offsets correctos
        parts = text.split(". ")
    ...
    return [
        SegmentoRaw(
            ...
            words=[
                ...
                WordTimestamp(
                    word="crecimiento", start=12.4, end=13.1, probability=0.89
                ),
...
class TestExtraerOraciones:
    ...
    def test_divide_segmento_en_dos_oraciones(
        self, segmentos_crudos, fake_nlp
    ):
    ...
    def test_cada_oracion_tiene_timestamps_correctos(
        self, segmentos_crudos, fake_nlp
    ):
    ...
    def test_cada_oracion_tiene_sus_words(
        self, segmentos_crudos, fake_nlp
    ):
    ...
    def test_procesa_multiples_segmentos(
        self, dos_segmentos_crudos, fake_nlp
    ):
    ...
    def test_oraciones_en_orden_cronologico(
        self, dos_segmentos_crudos, fake_nlp
    ):
